...
function ScrollToTop() {
  ...
  return (
    <Link to='/' onClick={(event) => handleScorll(event)} className={`fixed bottom-16 right-8 rotate-180 p-2 bg-white border-2 border-[#000A2D] rounded-full cursor-pointer max-md:p-1 ${isHidden ? 'hidden' : ''}`}>
